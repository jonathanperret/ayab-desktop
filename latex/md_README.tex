...
For flashing the firmware, avrdude has to be available on your system.\hypertarget{md_README_autotoc_md32}{}\doxysubsubsection{Debian/\+Ubuntu}\label{md_README_autotoc_md32}

\begin{DoxyCode}{0}
\DoxyCodeLine{sudo apt install python3.11 python3.11-\/dev python3.11-\/venv}
\DoxyCodeLine{sudo apt install libasound2-\/dev avrdude}
...
\DoxyCodeLine{sudo zypper install libasound2 alsa-\/devel avrdude}
