...
For information on how to install the release version of the software, see \href{http://manual.ayab-knitting.com}{\texttt{ http\+://manual.\+ayab-\/knitting.\+com}}\hypertarget{md_README_autotoc_md39}{}\doxysection{Running from Source \& Development}\label{md_README_autotoc_md39}
...
This repository uses \href{https://pre-commit.com/}{\texttt{ pre-\/commit}} hooks. After cloning the repo and installing the development dependencies, you should run {\ttfamily pre-\/commit install} to set up the git hook scripts. \hypertarget{md_README_autotoc_md40}{}\doxysubsection{Platform-\/\+Specific Setup}\label{md_README_autotoc_md40}
$<$details$>$

For flashing the firmware, avrdude has to be available on your system. ~\newline
 To be able to work on GUI elements and translation files, you will also need Qt Dev \& Localization Tools. \hypertarget{md_README_autotoc_md41}{}\doxysubsubsection{Debian/\+Ubuntu}\label{md_README_autotoc_md41}
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md42}{}\doxysubsubsection{open\+SUSE}\label{md_README_autotoc_md42}
...
\end{DoxyCode}
 \hypertarget{md_README_autotoc_md43}{}\doxysubsubsection{All Distributions}\label{md_README_autotoc_md43}
...
\end{DoxyCode}
 $<$/details$>$\hypertarget{md_README_autotoc_md44}{}\doxysubsection{Universal Setup Steps}\label{md_README_autotoc_md44}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md45}{}\doxysection{CI/\+CD on Git\+Hub}\label{md_README_autotoc_md45}
\hypertarget{md_README_autotoc_md46}{}\doxysubsection{Triggering a new build}\label{md_README_autotoc_md46}
...
The tag can be pushed from your local environment, or via the \href{https://github.com/AllYarnsAreBeautiful/ayab-desktop/releases/new}{\texttt{ \char`\"{}\+Draft a new Release\char`\"{}}} button on the Git\+Hub website.\hypertarget{md_README_autotoc_md47}{}\doxysubsection{Choosing the firmware release to be bundled with the build}\label{md_README_autotoc_md47}
